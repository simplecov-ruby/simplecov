...
# Files pulled in via `cover` without ever being loaded still get
# their lines classified: comments and whitespace are irrelevant, disabled
...
RSpec.describe "cover line classification", :sandbox do
  before { setup_project("faked_project") }

  it "classifies comments, whitespace, and disabled regions in never-loaded files" do
    ...
    # Line-by-line classification: the disabled region (lines 3-6) is
