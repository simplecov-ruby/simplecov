...
RSpec.describe SimpleCov::CLI do
  ...
  describe "colorizing subcommands in the standalone CLI process", mutant: false do
...

    {
      ...
      it "reaches no undefined method along the way for `#{subcommand}`" do
        _stdout, stderr, = Open3.capture3(RbConfig.ruby, "-I", lib, exe, subcommand, *extra_args)
