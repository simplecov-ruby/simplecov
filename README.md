...
2. Load and launch SimpleCov **at the very top** of your `test/test_helper.rb`
    ...
    **Note:** If SimpleCov starts after your application code is already loaded
    ...
    This is especially run if you run anything that keeps your tests application loaded like spring, check out the **[spring section](#want-to-use-spring-with-simplecov)**.
