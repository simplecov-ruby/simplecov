...
If you're making a Rails application, SimpleCov comes with a built-in adaptor (see below) for it, so you could use
+SimpleCov.start('rails')+ instead to get some handy tabs in the output webpage.
